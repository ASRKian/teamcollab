...
import com.lokendra.teamcollab.filters.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .sessionManagement(c -> c.sessionCreationPolicy(SessionCreationPolicy.STATELESS)) // to tell it's token
                                                                                                  // based auth not
                                                                                                  // session based
